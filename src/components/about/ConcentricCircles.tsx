...
const iconBubbles = [
  {
    src: "/images/common/icons/icon-analytics.svg",
    alt: "Analytics",
    glow: "bg-purple-500",
    top: 8.7,
    left: 80.2,
  ...
  {
    src: "/images/common/icons/icon-activity.svg",
    alt: "Activity",
    glow: "bg-orange-500",
    top: 2.0,
    left: 36.3,
  ...
  {
    src: "/images/common/icons/icon-edit.svg",
    alt: "Edit",
    glow: "bg-purple-400",
    top: 15.8,
    left: 13.4,
  ...
  {
    src: "/images/common/icons/icon-document.svg",
    alt: "Document",
  ...
  {
    src: "/images/common/icons/icon-scan.svg",
    alt: "Scan",
    glow: "bg-green-500",
    top: 37.1,
    left: 19.9,
  ...
  {
    src: "/images/common/icons/icon-graph.svg",
    alt: "Graph",
    glow: "bg-chalk-green-500",
    top: 18.3,
    left: 40.8,
  ...
  {
    src: "/images/common/icons/icon-meeting.svg",
    alt: "Meeting",
    glow: "bg-orange-500",
    top: 29.6,
    left: 95.5,
  ...
  {
    src: "/images/common/icons/icon-clipboard-check.svg",
    alt: "Clipboard-Check",
    glow: "bg-green-500",
    top: 9.2,
    left: 59.2,
  ...
  {
    src: "/images/common/icons/icon-task-list.svg",
    alt: "Task-List",
    glow: "bg-gray-500",
    top: 26.5,
    left: 73.2,
  ...
  {
    src: "/images/common/icons/icon-strategy.svg",
    alt: "Strategy",
    glow: "bg-chalk-green-500",
    top: 51.1,
    left: 90.1,
