...
const aiSections = [
  {
    ...
    items: [
      {
        title: "AI Proctoring",
        description: "AI-powered exam integrity monitoring at scale",
        href: "/ai/proctoring",
      },
    ],
  },
          ...
          <div className="flex flex-col gap-4">
            ...
            <div>
              ...
              >
                AI
                <ChevronDownIcon
                  className={`h-4 w-4 text-chalk-green-500 transition-transform ${mobileAiOpen ? "rotate-180" : ""}`}
                />
              </button>
              {mobileAiOpen && (
