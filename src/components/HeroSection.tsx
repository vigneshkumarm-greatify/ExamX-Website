...
export default function HeroSection() {
  return (
    <section className="relative min-h-[1090px] overflow-hidden">
      ...
      {/* ===== HERO TEXT CONTENT ===== */}
      <div className="absolute left-[122px] top-[141px] flex w-[665px] flex-col gap-9">
        {/* AI Empowered Badge */}
        <div className="flex flex-col gap-3">
          ...
          {/* Main Heading */}
          <h1 className="text-[47.78px] font-semibold leading-[1.2] tracking-[-0.02em]">
          ...
          {/* Description */}
          <p className="w-[444px] text-base font-medium leading-[1.5] tracking-[-0.01em] text-chalk-green-100">
