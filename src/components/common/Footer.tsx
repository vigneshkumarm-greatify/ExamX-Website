...
const socialLinks = [
  { name: "Facebook", icon: "/images/common/icons/icon-facebook.svg" },
  { name: "Instagram", icon: "/images/common/icons/icon-instagram.svg" },
  { name: "X", icon: "/images/common/icons/icon-x.svg" },
  { name: "LinkedIn", icon: "/images/common/icons/icon-linkedin.svg" },
  { name: "YouTube", icon: "/images/common/icons/icon-youtube.svg" },
];
    ...
    <footer className="relative overflow-hidden bg-gradient-to-b from-chalk-green-500 from-[22.8%] to-[#00c63e] to-[156.9%] px-6 pb-12 pt-16 md:px-12 md:pb-20 md:pt-[120px] desktop:px-[100px]">
      ...
      <div className="relative mx-auto flex max-w-[1280px] flex-col gap-10 md:gap-16">
        ...
        <a href="/" className="flex h-[49px] items-center gap-0">
          ...
          />
            ...
            <div className="flex gap-2.5">
              <Image
                src="/images/common/badges/badge-iso.png"
              ...
              />
              <Image
                src="/images/common/badges/badge-gdpr.png"
                alt="GDPR compliant"
                width={88}
                height={88}
                className="h-16 w-16 md:h-[88px] md:w-[88px]"
              />
              <Image
                src="/images/common/badges/badge-soc2.png"
                alt="SOC 2 certified"
                width={88}
                height={88}
                className="h-16 w-16 md:h-[88px] md:w-[88px]"
        ...
        <div className="flex justify-center">
          <Image
            src="/images/common/logos/footer-greatify-logo-large.svg"
            alt=""
            width={1280}
            height={303}
