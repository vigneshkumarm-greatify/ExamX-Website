...
const tabs = [
  {
    ...
    pills: [
      { icon: "/images/common/icons/icon-graduation-cap.svg", text: "Semester exam scheduling & delivery" },
      { icon: "/images/common/icons/icon-iris-scan-sm.svg", text: "AI proctoring for remote exams" },
      { icon: "/images/common/icons/icon-contact-book.svg", text: "Question bank with 20+ question types" },
      { icon: "/images/common/icons/icon-signal-full.svg", text: "Real-time analytics & result dashboards" },
    ],
  ...
  },
  {
    ...
    cta: "Explore Solution",
    pills: [
      { icon: "/images/common/icons/icon-graduation-cap.svg", text: "Grade-wise assessment scheduling" },
      { icon: "/images/common/icons/icon-iris-scan-sm.svg", text: "Safe exam browser for students" },
      { icon: "/images/common/icons/icon-contact-book.svg", text: "Curriculum-aligned question banks" },
      { icon: "/images/common/icons/icon-signal-full.svg", text: "Parent & teacher report cards" },
    ],
  ...
  },
  {
    ...
    cta: "Explore Solution",
    pills: [
      { icon: "/images/common/icons/icon-graduation-cap.svg", text: "National exam scheduling at scale" },
      { icon: "/images/common/icons/icon-iris-scan-sm.svg", text: "Biometric identity verification" },
      { icon: "/images/common/icons/icon-contact-book.svg", text: "Multi-language question delivery" },
      { icon: "/images/common/icons/icon-signal-full.svg", text: "Compliance & audit dashboards" },
    ],
  ...
  },
  {
    ...
    cta: "Explore Solution",
    pills: [
      { icon: "/images/common/icons/icon-graduation-cap.svg", text: "Technical skill assessments" },
      { icon: "/images/common/icons/icon-iris-scan-sm.svg", text: "AI-powered candidate screening" },
      { icon: "/images/common/icons/icon-contact-book.svg", text: "Custom branded exam portals" },
      { icon: "/images/common/icons/icon-signal-full.svg", text: "Hiring analytics & insights" },
    ],
  ...
  },
  {
    ...
    cta: "Explore Solution",
    pills: [
      { icon: "/images/common/icons/icon-graduation-cap.svg", text: "Professional certification delivery" },
      { icon: "/images/common/icons/icon-iris-scan-sm.svg", text: "Secure browser lockdown" },
      { icon: "/images/common/icons/icon-contact-book.svg", text: "Digital badge & certificate issuing" },
      { icon: "/images/common/icons/icon-signal-full.svg", text: "Psychometric item analysis" },
    ],
    pillBg: "bg-gradient-to-b from-purple-100 to-[#b7a7e6]",
    pillTextColor: "text-purple-500",
    pillIconBg: "bg-[rgba(211,202,240,0.2)]",
  ...
  },
  {
    ...
    cta: "Explore Solution",
    pills: [
      { icon: "/images/common/icons/icon-graduation-cap.svg", text: "AI-powered mock test creation" },
      { icon: "/images/common/icons/icon-iris-scan-sm.svg", text: "Adaptive practice exams" },
      { icon: "/images/common/icons/icon-contact-book.svg", text: "Performance tracking dashboards" },
      { icon: "/images/common/icons/icon-signal-full.svg", text: "White-label student portals" },
    ],
    pillBg: "bg-gradient-to-b from-green-50 to-green-300",
    pillTextColor: "text-green-700",
    pillIconBg: "bg-[rgba(184,245,203,0.2)]",
