...
const logos = [
  { src: "/images/home/logos/trusted-logos/adani-university.png", alt: "Adani University", width: 113, height: 38, containerWidth: 149 },
  { src: "/images/home/logos/trusted-logos/srm.png", alt: "SRM University", width: 120, height: 41, containerWidth: 132 },
  { src: "/images/home/logos/trusted-logos/middlesex-university.png", alt: "Middlesex University London", width: 108, height: 43, containerWidth: 128 },
  { src: "/images/home/logos/trusted-logos/koshys.png", alt: "Koshys Group of Institutions", width: 155, height: 26, containerWidth: 155 },
  { src: "/images/home/logos/trusted-logos/jsw.png", alt: "JSW", width: 89, height: 42, containerWidth: 110 },
  { src: "/images/home/logos/trusted-logos/narayana.png", alt: "Narayana", width: 66, height: 66, containerWidth: 78, blend: true },
  { src: "/images/home/logos/trusted-logos/dgsom.png", alt: "DGSOM School of Management", width: 127, height: 42, containerWidth: 139, blend: true },
  { src: "/images/home/logos/trusted-logos/viewsonic.png", alt: "ViewSonic", width: 172, height: 28, containerWidth: 172 },
];
...
export default function SolutionsTrustedBy() {
  ...
  return (
    <section className="py-12 md:py-16 lg:py-24">
      <div className="flex flex-col items-center gap-[41px]">
        ...
        <p className="text-neutral-500 mt-4 max-w-[450px] text-center mb-4">From top universities to government bodies organizations across the globe rely on ExamX.</p>
        </div>
